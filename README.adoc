...
The containers can be pinned to certain releases of `:latest`, for example with `:1.0.0`. Full list of versions can be found in link:https://github.com/teragrep?tab=packages&repo_name=ipa_01[packages list].
