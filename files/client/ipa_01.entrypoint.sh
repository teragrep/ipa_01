...
for required_env_var in IPA_01_SERVER_HOSTNAME IPA_01_DOMAIN IPA_01_ENROLL_USER_PASSWORD; do
...
ipa-client-install --unattended --server "${IPA_01_SERVER_HOSTNAME}" --domain "${IPA_01_DOMAIN,,}" --principal "srv-ipa_01@${IPA_01_DOMAIN^^}" --password "${IPA_01_ENROLL_USER_PASSWORD}" ${IPA_01_CLIENT_FLAGS};
